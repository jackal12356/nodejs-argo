...
const UUID = process.env.UUID || '87daaa4c-56c4-43d3-aad1-38152fb1574b'; // 使用哪吒v1,在不同的平台运行需修改UUID,否则会覆盖
...
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'dc.9943826.xyz';          // 固定隧道域名,留空即启用临时隧道
const ARGO_AUTH = process.env.ARGO_AUTH || 'eyJhIjoiYTIyMWM5NDJhZTBjNDg0ZDNhMmZjNTM4NDI5ODMxZDQiLCJ0IjoiZWQzMmVhZjctMjQyOS00MjFmLWIyOGMtZWMzZDE5ZDQwMzU4IiwicyI6IllUVTJORGd3TW1NdE1XTmtNUzAwTXpVNUxUZzJabUV0WVdObFpqZGpaV1JqWmpkaiJ9'
